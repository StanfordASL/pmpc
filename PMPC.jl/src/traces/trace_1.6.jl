...
precompile(Tuple{typeof(Base._array_for), Type{Tuple{Symbol, Float64}}, PyCall.PyDict{Symbol, PyCall.PyObject, true}, Base.HasLength, Int64})
...
precompile(Tuple{Base.var"#invokelatest##kw", NamedTuple{(:reg_x, :reg_u, :lx, :ux, :lu, :uu, :solver, :smooth_cstr, :smooth_alpha, :solver_state), Tuple{Float64, Float64, Array{Float64, 3}, Array{Float64, 3}, Array{Float64, 3}, Array{Float64, 3}, String, String, Float64, Nothing}}, typeof(Base.invokelatest), Any, Any, Vararg{Any, N} where N})
precompile(Tuple{Base.var"##invokelatest#2", Base.Iterators.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:reg_x, :reg_u, :lx, :ux, :lu, :uu, :solver, :smooth_cstr, :smooth_alpha, :solver_state), Tuple{Float64, Float64, Array{Float64, 3}, Array{Float64, 3}, Array{Float64, 3}, Array{Float64, 3}, String, String, Float64, Nothing}}}, typeof(Base.invokelatest), Any, Any, Vararg{Any, N} where N})
...
precompile(Tuple{Core.Compiler.var"#256#258"{DataType, Tuple{Base.Val{2}}}, Int64})
precompile(Tuple{Core.Compiler.var"#256#258"{DataType, Tuple{COSMO.var"#86#88", Bool}}, Int64})
precompile(Tuple{Core.Compiler.var"#256#258"{DataType, Tuple{Base.Sort.QuickSortAlg, Bool}}, Int64})
precompile(Tuple{Core.Compiler.var"#256#258"{DataType, Tuple{typeof(Base.:(<=))}}, Int64})
...
precompile(Tuple{Core.Compiler.var"#256#258"{DataType, Tuple{COSMO.var"#137#138"}}, Int64})
precompile(Tuple{Core.Compiler.var"#256#258"{DataType, Tuple{DataType}}, Int64})
...
precompile(Tuple{Type{Base.Pair{A, B} where B where A}, Symbol, Array{Float64, 3}})
...
precompile(Tuple{typeof(Base.maybeview), Array{Float64, 3}, Function, Function, Vararg{Any, N} where N})
...
precompile(Tuple{Core.Compiler.var"#256#258"{DataType, Tuple{Float64, Bool}}, Int64})
...
precompile(Tuple{typeof(SparseArrays._distributevals_halfperm!), SparseArrays.SparseMatrixCSC{Float64, Int64}, SparseArrays.SparseMatrixCSC{Float64, Int64}, Base.UnitRange{Int64}, SparseArrays.var"#9#10"})
precompile(Tuple{typeof(SparseArrays._absspvec_vcat), SparseArrays.SparseVector{Float64, Int64}, Vararg{SparseArrays.SparseVector{Float64, Int64}, N} where N})
...
precompile(Tuple{typeof(Base.hcat), SparseArrays.SparseMatrixCSC{Float64, Int64}, SparseArrays.SparseMatrixCSC{Float64, Int64}, SparseArrays.SparseMatrixCSC{Float64, Int64}, Vararg{SparseArrays.SparseMatrixCSC{Float64, Int64}, N} where N})
precompile(Tuple{typeof(Base.promote_eltype), SparseArrays.SparseMatrixCSC{Float64, Int64}, SparseArrays.SparseMatrixCSC{Float64, Int64}, Vararg{SparseArrays.SparseMatrixCSC{Float64, Int64}, N} where N})
precompile(Tuple{typeof(Base.map), SparseArrays.var"#29#30", Tuple{SparseArrays.SparseMatrixCSC{Float64, Int64}, SparseArrays.SparseMatrixCSC{Float64, Int64}, SparseArrays.SparseMatrixCSC{Float64, Int64}, SparseArrays.SparseMatrixCSC{Float64, Int64}, SparseArrays.SparseMatrixCSC{Float64, Int64}, SparseArrays.SparseMatrixCSC{Float64, Int64}, SparseArrays.SparseMatrixCSC{Float64, Int64}}})
...
precompile(Tuple{typeof(SparseArrays.blockdiag), SparseArrays.SparseMatrixCSC{Float64, Int64}, Vararg{SparseArrays.SparseMatrixCSC{Float64, Int64}, N} where N})
precompile(Tuple{typeof(SparseArrays._blockdiag), Type{Float64}, Type{Int64}, SparseArrays.SparseMatrixCSC{Float64, Int64}, Vararg{SparseArrays.SparseMatrixCSC{Float64, Int64}, N} where N})
...
precompile(Tuple{typeof(SparseArrays.spzeros), Int64, Int64})
precompile(Tuple{typeof(Base.setproperty!), PMPC.ConeProblem, Symbol, SparseArrays.SparseMatrixCSC{Float64, Int64}})
precompile(Tuple{typeof(Base.convert), Type{Union{Nothing, SparseArrays.SparseMatrixCSC{Float64, Int64}}}, SparseArrays.SparseMatrixCSC{Float64, Int64}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, PMPC.var"#51#53"{Base.Iterators.Pairs{Symbol, Bool, Tuple{Symbol}, NamedTuple{(:verbose,), Tuple{Bool}}}, ECOS.settings}, Tuple{Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Tuple{Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol}, PMPC.var"#51#53"{Base.Iterators.Pairs{Symbol, Bool, Tuple{Symbol}, NamedTuple{(:verbose,), Tuple{Bool}}}, ECOS.settings}}})
...
precompile(Tuple{Type{Base.Dict{Symbol, Any}}, Base.Pair{Symbol, Float64}, Vararg{Base.Pair{A, B} where B where A, N} where N})
...
precompile(Tuple{Base.var"#invokelatest##kw", NamedTuple{(:reg_x, :reg_u, :lx, :ux, :lu, :uu, :solver, :solver_state), Tuple{Float64, Float64, Array{Float64, 3}, Array{Float64, 3}, Array{Float64, 3}, Array{Float64, 3}, String, Nothing}}, typeof(Base.invokelatest), Any, Any, Vararg{Any, N} where N})
precompile(Tuple{Base.var"##invokelatest#2", Base.Iterators.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:reg_x, :reg_u, :lx, :ux, :lu, :uu, :solver, :solver_state), Tuple{Float64, Float64, Array{Float64, 3}, Array{Float64, 3}, Array{Float64, 3}, Array{Float64, 3}, String, Nothing}}}, typeof(Base.invokelatest), Any, Any, Vararg{Any, N} where N})
...
precompile(Tuple{typeof(Base.grow_to!), Base.Dict{Symbol, Float64}, Base.Generator{Base.Iterators.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:reg_x, :reg_u, :lx, :ux, :lu, :uu, :solver, :solver_state), Tuple{Float64, Float64, Array{Float64, 3}, Array{Float64, 3}, Array{Float64, 3}, Array{Float64, 3}, String, Nothing}}}, PMPC.var"#97#98"}, Int64})
...
precompile(Tuple{typeof(Base.grow_to!), Base.Dict{Symbol, Any}, Base.Generator{Base.Iterators.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:reg_x, :reg_u, :lx, :ux, :lu, :uu, :solver, :solver_state), Tuple{Float64, Float64, Array{Float64, 3}, Array{Float64, 3}, Array{Float64, 3}, Array{Float64, 3}, String, Nothing}}}, PMPC.var"#97#98"}, Int64})
...
precompile(Tuple{typeof(Base.setproperty!), PMPC.OSQPSolver{Float64}, Symbol, SparseArrays.SparseMatrixCSC{Float64, Int64}})
precompile(Tuple{typeof(Base.convert), Type{Union{Nothing, SparseArrays.SparseMatrixCSC{Float64, Ti} where Ti<:Integer}}, SparseArrays.SparseMatrixCSC{Float64, Int64}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, OSQP.var"#7#8"{Base.Dict{Symbol, Any}, OSQP.Settings}, Tuple{Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Tuple{Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol}, OSQP.var"#7#8"{Base.Dict{Symbol, Any}, OSQP.Settings}}})
precompile(Tuple{typeof(Base._array_for), Type{Float64}, Tuple{Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol}, Base.HasLength, Int64})
...
precompile(Tuple{Type{MathOptInterface.OptimizerWithAttributes}, Function, Base.Pair{String, Bool}})
...
precompile(Tuple{typeof(MathOptInterface.Utilities.mapreduce_constraints), MathOptInterface.Utilities.var"#164#165", typeof(Base.:(&)), MathOptInterface.Utilities.ModelFunctionConstraints{Float64}, Bool})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, JuMP.Containers.var"#78#79"{PMPC.var"#64#68"}, JuMP.Containers.VectorizedProductIterator{Tuple{Base.OneTo{Int64}}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{JuMP.Containers.VectorizedProductIterator{Tuple{Base.OneTo{Int64}}}, JuMP.Containers.var"#78#79"{PMPC.var"#64#68"}}})
...
precompile(Tuple{JuMP.var"##optimize!#113", Bool, MathOptInterface.Nonlinear.SparseReverseMode, Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(JuMP.optimize!), JuMP.Model})
...
#precompile(Tuple{Core.Compiler.var"#256#258"{DataType, Tuple{MosekTools.var"#16#17", Bool}}, Int64})
...
precompile(Tuple{typeof(Base._collect), Type{MathOptInterface.VariableIndex}, Base.Generator{Base.Iterators.Filter{MathOptInterface.Utilities.var"#142#143"{MathOptInterface.Utilities.VariablesContainer{Float64}}, Base.UnitRange{Int64}}, Type{MathOptInterface.VariableIndex}}, Base.SizeUnknown})
...
precompile(Tuple{typeof(MathOptInterface.Utilities.broadcastvcat), MathOptInterface.Utilities.var"#162#163"{MathOptInterface.ListOfConstraintTypesPresent}, MathOptInterface.Utilities.ModelFunctionConstraints{Float64}})
precompile(Tuple{typeof(MathOptInterface.Utilities.broadcastvcat), MathOptInterface.Utilities.var"#162#163"{MathOptInterface.ListOfConstraintTypesPresent}, MathOptInterface.Utilities.ModelScalarConstraints{Float64, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.ScalarAffineFunction{Float64}, MathOptInterface.ZeroOne}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.ScalarAffineFunction{Float64}, MathOptInterface.Integer}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.ScalarAffineFunction{Float64}, MathOptInterface.EqualTo{Float64}}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.ScalarAffineFunction{Float64}, MathOptInterface.GreaterThan{Float64}}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.ScalarAffineFunction{Float64}, MathOptInterface.LessThan{Float64}}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.ScalarAffineFunction{Float64}, MathOptInterface.Interval{Float64}}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.ScalarAffineFunction{Float64}, MathOptInterface.Semicontinuous{Float64}}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.ScalarAffineFunction{Float64}, MathOptInterface.Semiinteger{Float64}}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.ScalarAffineFunction{Float64}, MathOptInterface.Parameter{Float64}}}})
precompile(Tuple{typeof(MathOptInterface.get), MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.ScalarAffineFunction{Float64}, MathOptInterface.EqualTo{Float64}}, MathOptInterface.ListOfConstraintTypesPresent})
precompile(Tuple{typeof(Base.vcat), Array{Tuple{Type, Type}, 1}, Array{Tuple{Type, Type}, 1}, Array{Tuple{Type, Type}, 1}, Vararg{Array{Tuple{Type, Type}, 1}, N} where N})
precompile(Tuple{MathOptInterface.Utilities.var"#162#163"{MathOptInterface.ListOfConstraintTypesPresent}, MathOptInterface.Utilities.ModelVectorConstraints{Float64, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.Reals}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.Zeros}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.Nonnegatives}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.Nonpositives}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.Complements}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.NormInfinityCone}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.NormOneCone}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.SecondOrderCone}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.RotatedSecondOrderCone}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.GeometricMeanCone}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.ExponentialCone}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.DualExponentialCone}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.RelativeEntropyCone}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.NormSpectralCone}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.NormNuclearCone}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.PositiveSemidefiniteConeTriangle}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.PositiveSemidefiniteConeSquare}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.HermitianPositiveSemidefiniteConeTriangle}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.RootDetConeTriangle}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.RootDetConeSquare}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.LogDetConeTriangle}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.LogDetConeSquare}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.AllDifferent}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.CountDistinct}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.CountBelongs}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.CountAtLeast}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.CountGreaterThan}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.Circuit}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.Cumulative}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.Path}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.PowerCone{Float64}}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.DualPowerCone{Float64}}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.SOS1{Float64}}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.SOS2{Float64}}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.Indicator{MathOptInterface.ActivationCondition(0x00000001), MathOptInterface.LessThan{Float64}}}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.Indicator{MathOptInterface.ActivationCondition(0x00000000), MathOptInterface.LessThan{Float64}}}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.Table{Float64}}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.BinPacking{Float64}}, MathOptInterface.Utilities.VectorOfConstraints{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.HyperRectangle{Float64}}}})
...
precompile(Tuple{MathOptInterface.Utilities.var"#119#122", Tuple{DataType, DataType}})
...
precompile(Tuple{typeof(MathOptInterface.get), MathOptInterface.Utilities.GenericModel{Float64, MathOptInterface.Utilities.ObjectiveContainer{Float64}, MathOptInterface.Utilities.VariablesContainer{Float64}, MathOptInterface.Utilities.ModelFunctionConstraints{Float64}}, MathOptInterface.ListOfVariableAttributesSet})
...
precompile(Tuple{typeof(Base.collect), Base.Generator{Array{MathOptInterface.ScalarAffineTerm{Float64}, 1}, MathOptInterface.Utilities.var"#3#4"{MathOptInterface.Utilities.var"#1#2"{MathOptInterface.Utilities.IndexMap}}}})
precompile(Tuple{MathOptInterface.Utilities.var"#115#117", Tuple{DataType, DataType}})
...
precompile(Tuple{typeof(Base.collect), Base.Generator{Array{MathOptInterface.VectorAffineTerm{Float64}, 1}, MathOptInterface.Utilities.var"#3#4"{MathOptInterface.Utilities.var"#1#2"{MathOptInterface.Utilities.IndexMap}}}})
...
precompile(Tuple{typeof(Base._any), MathOptInterface.Utilities.var"#182#183"{MathOptInterface.ScalarAffineFunction{Float64}, MathOptInterface.EqualTo{Float64}}, Base.KeySet{MathOptInterface.ConstraintIndex{F, S} where S where F, Base.Dict{MathOptInterface.ConstraintIndex{F, S} where S where F, String}}, Base.Colon})
#precompile(Tuple{typeof(MathOptInterface.Utilities.pass_attributes), MathOptInterface.Bridges.LazyBridgeOptimizer{MosekTools.Optimizer}, MathOptInterface.Utilities.UniversalFallback{MathOptInterface.Utilities.GenericModel{Float64, MathOptInterface.Utilities.ObjectiveContainer{Float64}, MathOptInterface.Utilities.VariablesContainer{Float64}, MathOptInterface.Utilities.ModelFunctionConstraints{Float64}}}, MathOptInterface.Utilities.IndexMap, Array{MathOptInterface.ConstraintIndex{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.Nonnegatives}, 1}})
precompile(Tuple{typeof(Base._any), MathOptInterface.Utilities.var"#182#183"{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.Nonnegatives}, Base.KeySet{MathOptInterface.ConstraintIndex{F, S} where S where F, Base.Dict{MathOptInterface.ConstraintIndex{F, S} where S where F, String}}, Base.Colon})
precompile(Tuple{typeof(Base._any), MathOptInterface.Utilities.var"#241#243"{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.Nonnegatives}, Base.KeySet{MathOptInterface.ConstraintIndex{F, S} where S where F, Base.Dict{MathOptInterface.ConstraintIndex{F, S} where S where F, String}}, Base.Colon})
#precompile(Tuple{typeof(MathOptInterface.Utilities.pass_attributes), MathOptInterface.Bridges.LazyBridgeOptimizer{MosekTools.Optimizer}, MathOptInterface.Utilities.UniversalFallback{MathOptInterface.Utilities.GenericModel{Float64, MathOptInterface.Utilities.ObjectiveContainer{Float64}, MathOptInterface.Utilities.VariablesContainer{Float64}, MathOptInterface.Utilities.ModelFunctionConstraints{Float64}}}, MathOptInterface.Utilities.IndexMap, Array{MathOptInterface.ConstraintIndex{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.SecondOrderCone}, 1}})
precompile(Tuple{typeof(Base._any), MathOptInterface.Utilities.var"#182#183"{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.SecondOrderCone}, Base.KeySet{MathOptInterface.ConstraintIndex{F, S} where S where F, Base.Dict{MathOptInterface.ConstraintIndex{F, S} where S where F, String}}, Base.Colon})
precompile(Tuple{typeof(Base._any), MathOptInterface.Utilities.var"#241#243"{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.SecondOrderCone}, Base.KeySet{MathOptInterface.ConstraintIndex{F, S} where S where F, Base.Dict{MathOptInterface.ConstraintIndex{F, S} where S where F, String}}, Base.Colon})
#precompile(Tuple{typeof(MathOptInterface.Utilities.pass_attributes), MathOptInterface.Bridges.LazyBridgeOptimizer{MosekTools.Optimizer}, MathOptInterface.Utilities.UniversalFallback{MathOptInterface.Utilities.GenericModel{Float64, MathOptInterface.Utilities.ObjectiveContainer{Float64}, MathOptInterface.Utilities.VariablesContainer{Float64}, MathOptInterface.Utilities.ModelFunctionConstraints{Float64}}}, MathOptInterface.Utilities.IndexMap, Array{MathOptInterface.ConstraintIndex{MathOptInterface.VectorAffineFunction{Float64}, MathOptInterface.ExponentialCone}, 1}})
...
precompile(Tuple{typeof(Base.disable_sigint), Mosek.var"#374#377"{Mosek.Task, Mosek.Soltype, Array{Int32, 1}}})
...
precompile(Tuple{typeof(Base.disable_sigint), Mosek.var"#368#371"{Mosek.Task, Mosek.Soltype, Array{Int32, 1}}})
...
#precompile(Tuple{typeof(JuMP._moi_get_result), MathOptInterface.Utilities.CachingOptimizer{MathOptInterface.Bridges.LazyBridgeOptimizer{MosekTools.Optimizer}, MathOptInterface.Utilities.UniversalFallback{MathOptInterface.Utilities.GenericModel{Float64, MathOptInterface.Utilities.ObjectiveContainer{Float64}, MathOptInterface.Utilities.VariablesContainer{Float64}, MathOptInterface.Utilities.ModelFunctionConstraints{Float64}}}}, MathOptInterface.VariablePrimal, Vararg{Any, N} where N})
